...
FFTbor2D_212_sandbox : partition.o misc.o main.o
	$(CC) partition.o misc.o main.o $(LDFLAGS) -o FFTbor2D_212_sandbox
...
clean:
	rm -f *.o FFTbor2D_212_sandbox

install:
	cp FFTbor2D_212_sandbox $(BINDIR)
