...
void usage() {
  ...
  fprintf(stderr, "-P\tprecision,     the default is %d, indicates the precision (base 2) of the probabilities Z_k / Z to be returned (0-9, 0 disables precision handling).\n", std::numeric_limits<double>::digits);
