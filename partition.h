...
void   solveSystem(double *, dcomplex *, int, int, int, int *, int&, double&, int&);
void   printOutput(double *, int, int, int, int *, int&, double&, int&);
...
void   evaluateZ(int, dcomplex **, dcomplex **, dcomplex **, dcomplex **, dcomplex *, dcomplex *, short *, int **, int **, int ***, int, int, int, dcomplex *, int **, int **, int **,double **, double ***, double **, double ***, double **, double **, double **);
