...
double interiorloop(int, int, int, int, int, int, short, short, short, short, short, short);
...
void   evaluateZ(int, dcomplex **, dcomplex **, dcomplex **, dcomplex **, dcomplex *, dcomplex *, char *, char *, short *, int **, int **, int ***, int, int, int, int, double, dcomplex **, int **, int **, int **);
#endif
